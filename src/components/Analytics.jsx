    ...
    <div className="w-full bg-white py-16 px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        <img
          ...
          src={Labtop}
          alt="Laptop displaying analytics"
        />
        <div className="flex flex-col justify-center">
          ...
          <p>
            ...
            voluptatem accusantium quisquam molestias similique et aliquid
            quaerat illum, esse ipsa natus totam omnis a odio ipsum libero
            consectetur praesentium. Eius?
          </p>
